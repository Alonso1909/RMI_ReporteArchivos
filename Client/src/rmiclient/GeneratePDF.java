    ...
    public void crearPDF(File pdfNewFile, ArrayList<String> response, String ruta) throws DocumentException, IOException, FileNotFoundException {
        try {
            try {
                ...
                document.addSubject("Victor Manuel Cervantes Alonso");
                document.addKeywords("Java, PDF, iText");
                document.addAuthor("Victor Manuel Cervantes Alonso");
                document.addCreator("VAlonso");
                ...
                Paragraph paragraph = new Paragraph("Listado de Archivos", subcategoryFont);
